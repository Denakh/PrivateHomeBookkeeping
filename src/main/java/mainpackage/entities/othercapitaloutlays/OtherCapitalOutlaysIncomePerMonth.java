...
@Entity
public class OtherCapitalOutlaysIncomePerMonth {

    @Id
    @GeneratedValue
    private long id;

    @OneToOne(fetch = FetchType.LAZY, mappedBy = "otherCapitalOutlaysIncomePerMonth")
    ...
    public OtherCapitalOutlaysIncomePerMonth() {
    }
